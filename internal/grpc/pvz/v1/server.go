...
type PVZServerGRPC struct {
	UnimplementedPVZServiceServer
	srv PvzFinder
}

func NewPVZServerGRPC(s PvzFinder) *PVZServerGRPC {
	return &PVZServerGRPC{srv: s}
}

func (s *PVZServerGRPC) GetPVZList(ctx context.Context, _ *GetPVZListRequest) (*GetPVZListResponse, error) {
